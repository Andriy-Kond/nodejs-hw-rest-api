// Якщо не використовувати схему і файли з серверу, а юзати локальний файл contacts.json, то код буде наступним.

// const fs = require('fs/promises')

// вписати файли з минулого ДЗ (	listContacts,  getContactById, removeContact,  addContact,  updateContact,)
