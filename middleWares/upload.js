...
const multerConfig = multer.diskStorage({
  ...
  // У функцію передається об'єкт request, об'єкт файл і колбек.
  // file - це файл у пам'яті.
  // Тобто callback filename-а спрацьовує коли multer отримав file, зберіг його у пам'яті, але ще не зберіг його на диску
