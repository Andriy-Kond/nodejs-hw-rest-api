...
// А з фронтенду (uploadFrontend.html) ми юзаємо у скрипті FormData і коли fetch бачить цей formData, він теж додає цей заголовок

const path = require('path');

const tempDir = path.join(__dirname, '../', 'tmp');

// Об'єкт налаштувань multer-a (рушій дискового простору DiskStorage)
